...
test "cli parsing" {
    ...
    const args = [_][]const u8{ "ditch", "--n-trials", "5", "--row-normalization=pre", "--print-debug-information", "--good-prompts-dataset", "good.txt", "Qwen/Qwen2.5-0.5B-Instruct" };
