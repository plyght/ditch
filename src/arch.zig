...
pub const Names = struct {
    ...
    /// Fused `[2I][hidden]` gate/up tensor of the shared expert, relative to
    /// its prefix (Granite `input_linear.weight`); replaces expert_gate / expert_up.
...
pub const registry = [_]Arch{
    ...
    .{
        ...
        .chat = "granite",
        .verified = true,
        .notes = "fixture: embedding, attention and residual multipliers, logits scaling. Granite 3.x dense (Granite 4.0 H is `granitemoehybrid`; GraniteMoE is unsupported).",
        .extra = extraGranite,
    },
    .{
    ...
    .{
        ...
        .notes = "fixtures: Mamba2 and attention layers from layer_types (also the legacy mamba / attention names), embedding / attention / residual / logits multipliers, fused input_linear / output_linear experts with the shared_mlp, and the expert-free variant where shared_mlp is the dense MLP. Granite 4.0 H (tiny, small).",
