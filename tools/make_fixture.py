...
spec("solar_open", tok="llama3", L=2, rotary_dim=4, lm_head="lm_head.weight",
     ...
     config={"model_type": "solar_open", "hidden_size": 32, "moe_intermediate_size": 12, "num_hidden_layers": 2,
             ...
             "hidden_act": "silu", "max_position_embeddings": 128, "tie_word_embeddings": False})
# `mup_enabled`: the embeddings are scaled by sqrt(hidden_size), as Trinity's are.
spec("afmoe", tok="qwen2", L=3, qk_norm="head", attn_gate=("self_attn.gate_proj.weight", "sigmoid", False), embed_scale=np.sqrt(32.0),
     post_attn_norm="post_attention_layernorm.weight", pre_ff_norm="pre_mlp_layernorm.weight",
     post_ff_norm="post_mlp_layernorm.weight", sliding=4, sliding_layers=[1, 0, 1], rope_layers=[1, 0, 1],
     lm_head="lm_head.weight",
     ...
     config={"model_type": "afmoe", "hidden_size": 32, "intermediate_size": 32, "moe_intermediate_size": 12, "mup_enabled": True,
